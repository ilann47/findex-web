...
import { ExtensometerCalibrationForm } from '@/schemas/calibration'

const ExtensometerCalibrationReadingFields = ({ readingType }: CalibrationReadingProps) => {
	const { control } = useFormContext<ExtensometerCalibrationForm>()
...
export default ExtensometerCalibrationReadingFields
