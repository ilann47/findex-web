...
import { DeformimeterCalibrationForm } from '@/schemas/calibration'

const DeformimeterCalibrationReadingFields = ({ readingType }: CalibrationReadingProps) => {
	const { control } = useFormContext<DeformimeterCalibrationForm>()
...
export default DeformimeterCalibrationReadingFields
