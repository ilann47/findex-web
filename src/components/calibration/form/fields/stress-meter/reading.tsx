...
import { ConcreteTensometerCalibrationForm } from '@/schemas/calibration'

const ConcreteTensometerCalibrationReadingFields = ({ readingType }: CalibrationReadingProps) => {
	const { control } = useFormContext<ConcreteTensometerCalibrationForm>()
...
export default ConcreteTensometerCalibrationReadingFields
