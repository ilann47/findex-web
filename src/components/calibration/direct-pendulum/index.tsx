...
interface Props {
	calibration?: DirectPendulumCalibrationType
	showDate?: boolean
	isLoading?: boolean
	adornment?: ReactNode
	form?: boolean
...
export const DirectPendulumCalibration = ({
	calibration,
	showDate = true,
	adornment,
	isLoading = false,
	...
	const { remove } = useMutate({ endpoint: `${ENDPOINTS.CALIBRATION}/${ENDPOINTS.DIRECT_PENDULUM}` })
	...
	return (
		<LoadingContext.Provider value={isLoading}>
			<CalibrationTitle
				...
				instrumentType='DIRECT_PENDULUM'
				adornment={adornment}
				isLoading={isLoading}
			/>
