...
export const ConcreteTensometerFormulaDescription = () => {
	return (
		<>
			...
			<Text
				message={{
					id: 'instrument.engineering-value.formula.factory-factor',
					values: { value: '80T/D' },
				}}
			/>
			<Text
				message={{
					id: 'instrument.engineering-value.formula.elasticity',
					values: { value: 'Ex' },
				}}
			/>
			<Text
				message={{
					id: 'instrument.engineering-value.formula.thermal-expansion',
					values: { value: 'AC', magnitude: '(Kgf/cm2/%)' },
				}}
			/>
			<Text
				message={{
					id: 'instrument.engineering-value.formula.thermal-expansion',
					values: { value: 'B', magnitude: '(10-6/°C)' },
				}}
			/>
		</>
	)
