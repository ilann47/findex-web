...
import { ConcreteTensometerEngineeringData, EngineeringData } from '@/schemas/engineering-data'
...
export const ConcreteTensometerEngineeringDataTable = ({ instrument, getRowLink }: Props) => {
	...
	const {
		...
		totalElements,
		isLoading,
	} = useGetPageable<ConcreteTensometerEngineeringData>({
		endpoint: `${ENDPOINTS.ENGINEERING_DATA}/${ENDPOINTS.STRESS_METER}`,
		requestParams: { ...requestParams, sort: DATE_SORT },
	})

	const columnHelper = createColumnHelper<ConcreteTensometerEngineeringData>()

	const columns: ColumnDef<ConcreteTensometerEngineeringData>[] = [
	...
	] as ColumnDef<ConcreteTensometerEngineeringData>[]
