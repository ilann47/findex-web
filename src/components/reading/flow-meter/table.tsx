...
import { FlowMeterReading } from '@/schemas/reading'
...
export const FlowMeterReadingsTable = ({ instrument }: Props) => {
	...
	const {
		...
		totalElements,
		isLoading,
	} = useGetPageable<FlowMeterReading>({
		endpoint: `${ENDPOINTS.READING}/${ENDPOINTS.FLOW_METER}`,
		requestParams: { ...requestParams, sort: DATE_SORT },
	})

	const columnHelper = createColumnHelper<FlowMeterReading>()
